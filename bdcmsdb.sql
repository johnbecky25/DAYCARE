...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2023 at 10:46 PM
...
INSERT INTO `tblbabysitter` (`babysitter_id`, `FullName`, `Email`, `MobileNo`, `Address`, `City`, `State`, `LanguagesKnown`, `BabysitterExp`, `ProfilePic`, `Certificate`, `Description`, `RegDate`) VALUES
...
INSERT INTO `tblcontact` (`contact_ID`, `FirstName`, `LastName`, `Email`, `Phone`, `Message`, `EnquiryDate`, `IsRead`) VALUES
...
INSERT INTO `tblenrollment` (`Enrollment_ID`, `EnrollmentNumber`, `YourName`, `PhoneNumber`, `AlternateNumber`, `Email`, `ChildName`, `DOB`, `ChildGender`, `ProgramName`, `Address`, `Zipcode`, `City`, `State`, `Country`, `Landmark`, `EnrollDate`, `Remark`, `Status`, `RemarkDate`) VALUES
...
INSERT INTO `tblpage` (`page_id`, `PageType`, `PageTitle`, `PageDescription`, `Email`, `MobileNumber`, `UpdationDate`) VALUES
...
INSERT INTO `tblservices` (`service_id`, `ServiceName`, `ServiceDetail`, `CreationDate`) VALUES
...
INSERT INTO `users` (`User_id`, `FullName`, `UserName`, `MobileNumber`, `UserEmail`, `Password`) VALUES
...
--
ALTER TABLE `tblbabysitter`
  MODIFY `babysitter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tblenrollment`
  MODIFY `Enrollment_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
