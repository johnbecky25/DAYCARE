   ...
   <body>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3" >
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3" style="color:blue;padding-top: 20px;">Enrollment Form</h3>
            
            <div class="wthree-info-para">
               <!--contact-map -->
               <form method="post">
                  <h6 class="title text-left mb-lg-5 mb-md-4 mb-sm-4 mb-3" style="color:blue;padding-top: 20px;">Primary Details</h6>
                  ...
                  <h6 class="title text-left mb-lg-5 mb-md-4 mb-sm-4 mb-3" style="color:blue;padding-top: 20px;">Address Details</h6>
                 <div class="contact-mid row">
